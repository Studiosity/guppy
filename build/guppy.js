...
<h3>Settings</h3><table id=\"guppy_settings_table\"></table>";
    ...
    Guppy.prototype.set_buttons = function () {
        ...
        if (buttons) {
            for (var i = 0; i < buttons.length; i++) {
                ...
                });else if (buttons[i] == "send") Guppy.make_button("send", this.buttons_div, function () {
                    _this.engine.fire_event("done");
                });
            }
        }
    };
    ...
    */
    ...
    Guppy.init = function () {
        var symbols$$1 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_SYMBOLS;

        if (Guppy.initialised) return;
        Symbols.add_symbols(symbols$$1);
